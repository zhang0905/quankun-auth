...
// 是否错误对象
export const isError = (s) => {
    return Object.prototype.toString.call(s).slice(8, -1) === 'Error';
}
// 是否Symbol函数
export const isSymbol = (s) => {
    return Object.prototype.toString.call(s).slice(8, -1) === 'Symbol';
}
// 是否Promise对象
...
export const isSet = (s) => {
    return Object.prototype.toString.call(s).slice(8, -1) === 'Set';
}
// 是否是微信浏览器
...
// 在字符串中插入新的字符串
export const inserStr = (soure, index, newStr) => {
